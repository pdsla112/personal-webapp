            ...
            <div id="home-top-box">
                ...
                <div className="home-top-box-right-box">
                    ...
                    <p className="home-top-box-txt">
                        ...
                        You can view my personal projects, as well as the reason why I believe that I am ready to learn from your opportunity.
                        ...
                        Also, if this web application is kind of buggy, sorry! I will come back to improving this web-app later when I have less urgent school work to do. 
                        Enjoy!
                    </p>
                </div>
            </div>
